...
基于微信小程序原生框架（JavaScript + WXML + WXSS）实现的唐山皮影内容展示、音频播放与制作体验应用。

## 当前状态

- 已完成首页资讯、经典剧目、九工序虚拟体验、个人中心、收藏与全局音频播放能力。
...
### 3) 虚拟体验（`pages/experience/`）

- 支持入口、选角、工坊总览、工艺图鉴、玩法说明与成品展示。
- 依次完成识皮、制稿、描样、雕刻、敷彩、部件处理、连缀关节、装杆和灯影检验。
- 进入体验流程时暂停剧目音频，离开后恢复；体验 BGM 与音效可独立开关。
- 游戏状态只保存在当前运行会话中，重新开始会清空进度。

### 4) 我的（`pages/settings/index`）

- 本地头像与昵称编辑（仅保存在本机）。
- 收藏统计与收藏预览，支持跳转“查看全部”。
- 虚拟体验 BGM 开关，与体验入口中的同名设置同步。
